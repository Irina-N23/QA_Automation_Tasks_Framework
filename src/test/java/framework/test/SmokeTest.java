...
public class SmokeTest  extends CommonConditions {
    @Test(description = "Checks whether estimated total cost on Calculator page"
                        + " is equal to total cost from manual test.")
    public void totalEstimatedMonthlyCostInCalculatorEqualsToManualTestResult() {
        ...
        boolean expectedValue = new GoogleCloudPage(driver)
                ...
                .estimate()
                .isEstimatedCostOnCalculatorPageEqualToCostFromManualTest(testModel);
